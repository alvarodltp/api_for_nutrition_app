...
users = User.create([{name: "Alvaro", age: 29, weight: 195.0, height: 5.11, gender: "male", activity_level: "3 days per week"}, {name: "Ash", age: 25, weight: 120, height: 5.5, gender: "female", activity_level: "5 days per week"}])
